...
def get_inpainting_metrics(src, tgt):
    ...
    for p1, p2 in tqdm(zip(input_paths, output_paths)):
        ...
        psnr_ = peak_signal_noise_ratio(img1, img2)
        # ssim_ = compare_ssim(rgb2gray(img1), rgb2gray(img2))
        ssim_ = structural_similarity(img1, img2, multichannel=True)
...
if __name__ == '__main__':
    ...
    test_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/ballet/ballet_Gauiters"
    # test_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/lama-main/output/ballet/best/lama"
    save_json_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/ballet/ballet_metiic.json"
    save_excel_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/ballet/" + "single_frame_metrics_Gauiters.xlsx"


    # eval_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/Dataset/breakdancers/MSR3DVideo-Breakdancers/cam4-color"
    # test_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/breakdancers/breakdancers_proposed"
    # # test_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/lama-main/output/breakdancers/final"
    # save_json_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/breakdancers/breakdancers_metiic.json"
    # save_excel_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/breakdancers/" + "single_frame_metrics_proposed.xlsx"

    # eval_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/Dataset/Balloons/images/balloons1"
    # test_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/Balloons/Balloons_Gauiters"
    # save_json_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/Balloons/Balloons_metiic.json"
    # save_excel_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/Balloons/" + "single_frame_metrics_Gauiters.xlsx"

    # eval_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/Dataset/kendo/images/kendo1"
    # test_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/kendo/kendo_Gauiters"
    # save_json_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/kendo/kendo_metiic.json"
    # save_excel_path = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/comparison_methods/result/kendo/" + "single_frame_metrics_Gauiters.xlsx"
