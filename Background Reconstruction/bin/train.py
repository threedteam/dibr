...
os.environ['TORCH_HOME'] = '/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/lama-main/'
os.environ['PYTHONPATH'] = '/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/lama-main/'
...
def main(config: OmegaConf):
    try:
        ...
        # checkpoint_pretrained = "/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/lama-main/experiments/zrway_2023-12-28_15-34-02_train_lama-fourier_/models/27.ckpt"
        ...
        trainer = Trainer(
            ...
            # resume_from_checkpoint=checkpoint_pretrained,
            **trainer_kwargs
        )
...
if __name__ == '__main__':
    ...
    file_path = '/media/zrway/7f6f1ac1-24aa-4dfb-ab0a-ed8c3287463d/rxw/lama-main/output/time_record/training_time.txt'
